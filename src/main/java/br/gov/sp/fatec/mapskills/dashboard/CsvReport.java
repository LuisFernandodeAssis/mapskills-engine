...
/**
 * 
 * A classe {@link CsvReport} representa a view
...
public class CsvReport {
	...
	@OrderBy("skillName")
	private final List<StudentResultIndicator> studentsIndicator = new LinkedList<>();
	...
	public List<StudentResultIndicator> getStudentsIndicator() {
		return Collections.unmodifiableList(studentsIndicator);
	}
}